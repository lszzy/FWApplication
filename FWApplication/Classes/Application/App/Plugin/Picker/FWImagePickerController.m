...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem fwBarItemWithObject:[FWApplicationBundle localizedString:@"取消"] target:self action:@selector(cancelItemClicked:)];
