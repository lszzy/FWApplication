...
- (void)renderView
{
    ...
    [mobileField fw_addToolbarWithTitle:[NSAttributedString.fw attributedString:mobileField.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    ...
    [passwordField fw_addToolbarWithTitle:[NSAttributedString.fw attributedString:passwordField.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    ...
    [textView fw_addToolbarWithTitle:[NSAttributedString.fw attributedString:textView.fw_placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    inputView.fw_delegate = self;
    inputView.fw_previousResponderTag = 3;
    [inputView fw_addToolbarWithTitle:[NSAttributedString.fw attributedString:inputView.fw_placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
