...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *iconLabel = [UILabel fwLabelWithText:@"我是文本" font:[UIFont fwFontOfSize:15] textColor:[Theme textColor]];
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *iconLabel = [UILabel fwLabelWithText:@"我是头视图" font:[UIFont fwFontOfSize:15] textColor:[Theme textColor]];
        _iconLabel = iconLabel;
        [self.contentView addSubview:iconLabel];
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *iconLabel = [UILabel fwLabelWithText:@"我是尾视图" font:[UIFont fwFontOfSize:15] textColor:[Theme textColor]];
        _iconLabel = iconLabel;
        [self.contentView addSubview:iconLabel];
        iconLabel.fwLayoutChain.rightWithInset(20).centerYToView(iconView).leftToRightOfViewWithOffset(iconView, 20);
    }
