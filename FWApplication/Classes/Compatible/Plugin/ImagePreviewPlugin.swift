...
extension Wrapper where Base: UIViewController {
    ...
    public var imagePreviewPlugin: ImagePreviewPlugin? {
        get { return base.__fw.imagePreviewPlugin }
        set { base.__fw.imagePreviewPlugin = newValue }
    }
    ...
    public func showImagePreview(imageURLs: [Any], imageInfos: [Any]?, currentIndex: Int, sourceView: ((Int) -> Any?)? = nil) {
        base.__fw.showImagePreview(withImageURLs: imageURLs, imageInfos: imageInfos, currentIndex: currentIndex, sourceView: sourceView)
    }
    ...
    public func showImagePreview(imageURLs: [Any], imageInfos: [Any]?, currentIndex: Int, sourceView: ((Int) -> Any?)?, placeholderImage: ((Int) -> UIImage?)?, renderBlock: ((UIView, Int) -> Void)?, customBlock: ((Any) -> Void)? = nil) {
        base.__fw.showImagePreview(withImageURLs: imageURLs, imageInfos: imageInfos, currentIndex: currentIndex, sourceView: sourceView, placeholderImage: placeholderImage, renderBlock: renderBlock, customBlock: customBlock)
    }
...
extension Wrapper where Base: UIView {
    ...
    public var frameApplyTransform: CGRect {
        get { return base.__fw.frameApplyTransform }
        set { base.__fw.frameApplyTransform = newValue }
    }
