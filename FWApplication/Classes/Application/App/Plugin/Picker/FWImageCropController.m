...
- (void)showAspectRatioDialog
{
    ...
    NSString *cancelButtonTitle = _cancelButtonTitle ?: [FWApplicationBundle localizedString:@"取消"];
    NSString *originalButtonTitle = self.originalAspectRatioName.length > 0 ? self.originalAspectRatioName : [FWApplicationBundle localizedString:@"原有"];
...
- (void)setup {
    ...
    [_doneTextButton setTitle: _doneTextButtonTitle ?
        _doneTextButtonTitle : [FWApplicationBundle localizedString:@"完成"]
    ...
    [_cancelTextButton setTitle: _cancelTextButtonTitle ?
        _cancelTextButtonTitle : [FWApplicationBundle localizedString:@"取消"]
                       forState:UIControlStateNormal];
