...
- (void)renderView
{
    ...
    [mobileField.fw addToolbarWithTitle:[NSAttributedString fwAttributedString:mobileField.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    ...
    [passwordField.fw addToolbarWithTitle:[NSAttributedString fwAttributedString:passwordField.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    ...
    [textView.fw addToolbarWithTitle:[NSAttributedString fwAttributedString:textView.fw.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
    inputView.fw.delegate = self;
    inputView.fw.previousResponder = textView;
    [inputView.fw addToolbarWithTitle:[NSAttributedString fwAttributedString:inputView.fw.placeholder withFont:[UIFont systemFontOfSize:13.0]] doneBlock:nil];
