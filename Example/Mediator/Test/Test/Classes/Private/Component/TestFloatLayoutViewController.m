...
- (void)renderView
{
    ...
    self.floatLayoutView.fw_layoutChain.leftWithInset(24).rightWithInset(24).topWithInset(36);
    ...
    for (NSInteger i = 0; i < suggestions.count; i++) {
        if (i < 3) {
            ...
            [label fw_setBorderColor:[Theme textColor] width:0.5 cornerRadius:10];
            ...
            [button fw_setBorderColor:[Theme textColor] width:0.5 cornerRadius:10];
