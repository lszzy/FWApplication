...
extension Wrapper where Base: UIView {
    ...
    public func showBadgeView(_ badgeView: BadgeView, badgeValue: String? = nil) {
        base.__fw.show(badgeView, badgeValue: badgeValue)
    }

    /// 隐藏提醒灯
    public func hideBadgeView() {
        base.__fw.hideBadgeView()
    }
