...
- (void)renderView
{
    UIButton *button = [UIButton fw_buttonWithTitle:@"Button重复点击" font:[UIFont fw_fontOfSize:15] titleColor:[Theme textColor]];
    button.frame = CGRectMake(25, 15, 150, 30);
    [button fw_addTouchTarget:self action:@selector(onClick1:)];
    [self.view addSubview:button];
    
    UILabel *label = [UILabel fw_labelWithFont:[UIFont fw_fontOfSize:15] textColor:[Theme textColor] text:@"View重复点击"];
    ...
    button = [UIButton fw_buttonWithTitle:@"Button不可重复点击" font:[UIFont fw_fontOfSize:15] titleColor:[Theme textColor]];
    button.frame = CGRectMake(25, 60, 150, 30);
    [button fw_addTouchTarget:self action:@selector(onClick3:)];
    [self.view addSubview:button];
    
    label = [UILabel fw_labelWithFont:[UIFont fw_fontOfSize:15] textColor:[Theme textColor] text:@"View不可重复点击"];
    label.textAlignment = NSTextAlignmentCenter;
    label.userInteractionEnabled = YES;
    ...
    [button1 fw_setImage:[TestBundle imageNamed:@"icon_scan"]];
    ...
    [button2 fw_setImage:[TestBundle imageNamed:@"icon_scan"]];
    ...
    [button3 fw_setImage:[TestBundle imageNamed:@"icon_scan"]];
    ...
    [button4 fw_setImage:[TestBundle imageNamed:@"icon_scan"]];
