...
#pragma mark - FWApplicationBundle

@implementation FWApplicationBundle
...
+ (NSBundle *)bundle
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        if (!bundle) {
            bundle = [[NSBundle fwBundleWithClass:[FWApplicationBundle class] name:@"FWApplication"] fwLocalizedBundle];
        }
    });
    return bundle;
}
