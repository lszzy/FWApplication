...
extension Wrapper where Base: UIViewController {
    ...
    public var modalTransition: AnimatedTransition? {
        get { return base.__fw.modalTransition }
        set { base.__fw.modalTransition = newValue }
    }

    /// 视图控制器push|pop转场，代理导航控制器转场，需在fwNavigationTransition设置后生效
    public var viewTransition: AnimatedTransition? {
        get { return base.__fw.viewTransition }
        set { base.__fw.viewTransition = newValue }
    }
    ...
    public func setPresentTransition(_ presentationBlock: ((PresentationController) -> Void)?) -> AnimatedTransition {
        return base.__fw.setPresentTransition(presentationBlock)
    }
    ...
    public func setAlertTransition(_ presentationBlock: ((PresentationController) -> Void)?) -> AnimatedTransition {
        return base.__fw.setAlertTransition(presentationBlock)
    }
    ...
    public func setFadeTransition(_ presentationBlock: ((PresentationController) -> Void)?) -> AnimatedTransition {
        return base.__fw.setFadeTransition(presentationBlock)
    }
    ...
    public var presentationDidDismiss: (() -> Void)? {
        get { return base.__fw.presentationDidDismiss }
        set { base.__fw.presentationDidDismiss = newValue }
    }
    ...
    public func setPopoverPresentation(_ presentationBlock: ((UIPopoverPresentationController) -> Void)?, shouldDismiss: Bool) {
        base.__fw.setPopoverPresentation(presentationBlock, shouldDismiss: shouldDismiss)
    }
...
extension Wrapper where Base: UIView {
    ...
    public func transition(to viewController: UIViewController, pinEdges: Bool) -> UIView {
        return base.__fw.transition(to: viewController, pinEdges: pinEdges)
    }

    /// 包装到转场控制器(pinEdges占满父视图)，返回创建的控制器
    public func wrappedTransitionController(_ pinEdges: Bool) -> UIViewController {
        return base.__fw.wrappedTransitionController(pinEdges)
    }
...
extension Wrapper where Base: UINavigationController {
    ...
    public var navigationTransition: AnimatedTransition? {
        get { return base.__fw.navigationTransition }
        set { base.__fw.navigationTransition = newValue }
    }
