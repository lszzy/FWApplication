...
- (void)renderView
{
    ...
    [mobileField.fw addToolbarWithTitle:mobileField.placeholder previousButton:[self keyboardUpImage] nextButton:[self keyboardDownImage] rightButton:@(UIBarButtonSystemItemDone) block:nil];
    ...
    [passwordField.fw addToolbarWithTitle:passwordField.placeholder previousButton:[self keyboardUpImage] nextButton:[self keyboardDownImage] rightButton:@(UIBarButtonSystemItemDone) block:nil];
    ...
    [textView.fw addToolbarWithTitle:textView.fw.placeholder previousButton:[self keyboardUpImage] nextButton:[self keyboardDownImage] rightButton:@(UIBarButtonSystemItemDone) block:nil];
    inputView.fw.delegate = self;
    inputView.fw.previousResponder = textView;
    [inputView.fw addToolbarWithTitle:inputView.fw.placeholder previousButton:[self keyboardUpImage] nextButton:[self keyboardDownImage] rightButton:@(UIBarButtonSystemItemDone) block:nil];
