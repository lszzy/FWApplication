...
**本仓库已迁移合并至FWFramework最新4.0.0+版本，后续不再单独维护，请移步[FWFramework](https://github.com/lszzy/FWFramework)。**
...
由于本框架一直在升级优化和扩展新功能，各版本Api可能会有些许变动，如果升级新版本时编译报错，解决方案如下：
	...
	1. 改为指定pod版本号引入即可，推荐方式，不影响项目进度，有空才升级到新版本，示例：pod 'FWApplication', '3.8.1'
