...
- (void)setVideoPlayerItem:(AVPlayerItem *)videoPlayerItem {
    ...
    self.videoPlayerView.frame = CGRectMake(0, 0, self.videoSize.width, self.videoSize.height);
...
- (void)setImageURL:(id)imageURL placeholderImage:(UIImage *)placeholderImage {
    ...
    if ([imageURL isKindOfClass:[NSURL class]]) {
        ...
        [self.imageView fwSetImageWithURL:imageURL placeholderImage:placeholderImage options:0 context:nil completion:^(UIImage * _Nullable image, NSError * _Nullable error) {
